<template>
	<section>
		...
		<!--列表-->
		<el-table :data="depts" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;" height="550">
		...
		<el-dialog title="新增" :visible.sync="addFormVisible">
			<el-form :model="addForm" label-width="80px" :rules="FormRules" ref="addForm">
				...
				<el-form-item label="部门主管" prop="deptMId" >
					<el-select v-model="addForm.deptMId" placeholder="请选择上级部门" filterable>
						<el-option
							v-for="user in users"
							:key="user.userId"
							:label="user.name"
		...
		<el-dialog title="查看部门员工" :visible.sync="deptUsersVisible" :close-on-click-modal="false">
			<!--列表-->
			<el-table :data="deptUsers" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
